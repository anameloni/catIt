...
// Menu
// ================================================================================================================
export function MeowiMenu({ profileImg }) {
  const [isMenuOpen, setMenuState] = React.useState(false);

  return (
    <MeowiMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <MeowiMenu.Logo src={`${BASE_URL}/logo.svg`} />
      ...
      <MeowiMenuProfileSidebar profileImg={profileImg} />
    </MeowiMenu.Wrapper>
  )
}

MeowiMenu.Wrapper = styled.header`
  width: 100%;
...
function MeowiMenuProfileSidebar({ profileImg }) {
  return (
    <div className="alurakutMenuProfileSidebar">
      <div>
        <img src={`https://github.com/${profileImg}.png`} style={{ borderRadius: '8px' }} />
        <hr />
        <p>
          <a className="boxLink" href={`/user/${profileImg}`}>
            @{profileImg}
          </a>
        </p>
        <hr />

        <MeowiProfileSidebarMenuDefault />
      </div>
    </div>
  )
}
...
// MeowiProfileSidebarMenuDefault
// ================================================================================================================
export function MeowiProfileSidebarMenuDefault() {
  return (
    <MeowiProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
MeowiProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
